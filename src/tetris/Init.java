...
public class Init extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        input_txt.setText("your name");

        input_lbl.setText("Input Name:");

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("Left Arrow Key: Left\nRight Arrow Key: Right\nSpace Bar: Rotate CCW\n");
        ...
        mainTestPanel_lbl.setText("TETRIS");
...
//        mainTestPanel_lbl.setText(newTitle);
        Game.canStart = true;
        Game.playerName = input_txt.getText();
